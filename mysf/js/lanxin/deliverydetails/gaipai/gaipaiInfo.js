...
$(function() {
	...
	$('#btnBack').attr('href','/page/lanxin/deliverydetails/routing/waybill-2-1-routing.html?bno='+urlParams.bno+'&&hasRoute=true');
});
...
function toWayBill(){
	var url = '/page/lanxin/deliverydetails/routing/waybill-2-1-routing.html';
