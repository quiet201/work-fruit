...
$(document).ready(function(){
	...
	$.post("/service/commonLog/addLog/L00201");
		...
		//var url="/../../tencent/deliverydetails/no-routing/sf07_1-1-ok.html?bno="+bno;
...
function btnClick(){
	...
	if('false'== noMessage){
		...
		$.ajax({
			...
			async : false,
			dataType : "json",
			url : "/service/order/orderContro/aMessage/"+bno+"/1/"+selectedLabel+"/"+encodeURI(encodeURI(msg))+"/3",
			success : function(data) {
				if('0'==data||null==data){
