...
function getOrderInfo(orderNos){
	$.ajax({
		...
		data : {
			orderNo : orderNos,
			evalType:'1',//评价类型 1  收件 2 派件
			channel:'3'
		},
		dataType : "json",
		url : "/service/alipay/getOrderInfoByNo",
		success : function(data) {
			
			var obj = data;
			//$("#orderNo").text(obj.orderNo);
			
			$("#waybill-num").text(obj.bno);
