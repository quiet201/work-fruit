...
function listem(){
	$("#checkedOne").unbind().bind("click",function(){
		...
		getAddressDetail("/page/lanxin/address/province.html?addrName=destName&addrCode=destCode&addrCountyName=dcountyName&addrCountyCode=dcountyCode&type=3&gatChild=-1");
	});
};
