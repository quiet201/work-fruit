...
var yjFlag = '';
 ...
 //判断当前运单状态 1。电子运单  0.普通运单 默认为电子运单
    ...
    //var url ='../../lanxin/range/ship_submit.html';
...
//		 }
	...
	function toConfirmPage(){
		var orderJson =  packagingOrderData();
		window.location = "/../../lanxin/range/ship_submit.html?orderJson="+encodeURI(orderJson);
	}
...
//		cityNames[3] = ['755'];
	...
	function toSelectAddressBook(){
		...
		location.href = "/page/lanxin/addressbook/send/address_menber1.html?addressToPage=/page/lanxin/order/ship.html&shipAskId="+shipAskId;
	}
			...
			success: function(result){
				if(result){
					if(result.code == "200"){
						...
						clearCookie();
						//跳转成功页面
						window.location = "/page/lanxin/order/ship_success.html?resultJson="+JSON.stringify(result);
