$(document).ready(function(){
	...
	$("#nearSubmit").off("click").on("click",function(){
		...
		var url="/page/telephoneBind/nearby/storeList.html?proName="+proName+"&cityName="+srcName+"&countyName="+acountyName+"&keyWord="+inputValue;
		if($.trim(type)!=""){
			url="/page/telephoneBind/nearby/storeList.html?cityName="+srcName+"&countyName="+acountyName+"&keyWord="+inputValue;
		}
