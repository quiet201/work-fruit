...
function dosubmit(){
	...
	$.ajax({
		...
		data : mm,
		dataType : "json",
		url : "/service/telephoneBind/buttonToPhonebind",
		success: function(code){
			if(code+"" == "200"){
				...
				window.location = "/page/telephoneBind/bind/binded.html?phone="+temp;
				}
			}else{
...
function sendValidateCode(){
	...
	var url = "/service/telephoneBind/phonebindcode/"+$("#phoneNo").val();
	$.ajax({
		type : "GET",
		dataType : "json",
		url : url,
