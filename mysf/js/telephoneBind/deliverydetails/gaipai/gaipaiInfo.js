...
$(function() {
	...
	$('#btnBack').attr('href','/page/telephoneBind/deliverydetails/routing/waybill-2-1-routing.html?bno='+urlParams.bno+'&&hasRoute=true');
});
...
function checkStyle(bno){
	$.ajax({
		...
		success : function(data) {
			...
			getCommonImg("10552","N","2");
		},
		error : function(e) {
			//tipsDialog("查询失败");
			getCommonImg("10552","N","3");
		}
	});
...
function toWayBill(){
	var url = '/page/telephoneBind/deliverydetails/routing/waybill-2-1-routing.html';
