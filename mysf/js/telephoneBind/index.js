...
function listem(){
	$("#queryText").focus(function() {
		location.href = "/page/telephoneBind/deliverydetails/query.html";
	});
	//设置监听效果
	...
	$.ajax({
		...
		success: function(json){
			...
			if(json){
				...
				$("#bindForward").attr("href","/page/telephoneBind/bind/binded.html?phone="+json);
			}else{
				//如果没有绑定跳转到绑定页面
				$("#bindForward").attr("href","/page/telephoneBind/bind/bind.html");
			}
		},
