...
function editAddressInfo(asbkid){
	...
	location.href = "/page/telephoneBind/addressbook/mybook/address_edit_sent3.html?asbkId="+asbkid;
};
//删除地址簿
...
//						alert("删除成功!");
						if($.trim(data)!=""){
							...
							setTimeout(function() {
								location.href = "/page/telephoneBind/addressbook/mybook/address_menber3.htm";
							},80);
						}else{
...
function checkOne(index){
	...
	setTimeout(function() {
		location.href ="/page/telephoneBind/addressbook/mybook/addressDetails3.html?sentAsbkId="+index;
					...
					$.ajax({
						...
						success : function(dataOne) {
							if(dataOne){
								...
								location.href= "/page/telephoneBind/addressbook/mybook/address_menber3.html";
