...
function editAddressInfo(asbkid){
	...
	location.href = "/page/tencent/addressbook/receive/address_edit_sent2.html?asbkId="+asbkid;
};
//删除地址簿
...
//						alert("删除成功!");
						if($.trim(data)!=""){
							...
							setTimeout(function() {
								location.href = "/page/tencent/addressbook/receive/address_menber2.htm";
							},80);
						}else{
