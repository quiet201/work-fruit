$(document).ready(function(){
	...
	$("#nearSubmit").off("click").on("click",function(){
		...
		var url="/page/alipay/nearby/storeList.html?proName="+proName+"&cityName="+srcName+"&countyName="+acountyName+"&keyWord="+inputValue;
		if($.trim(type)!=""){
			url="/page/alipay/nearby/storeList.html?cityName="+srcName+"&countyName="+acountyName+"&keyWord="+inputValue;
		}
