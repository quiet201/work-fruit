...
Calendar.prototype.draw = function() {
  ...
  mvAry[mvAry.length]  = '    <table width="100%" border="0" cellpadding="0" cellspacing="1" style="table-layout:auto;">';
  mvAry[mvAry.length]  = '      <tr>';
  mvAry[mvAry.length]  = '        <th align="left" width="1%"><input style="border: 1px solid ' + calendar.colors["input_border"] + ';background-color:' + calendar.colors["input_bg"] + ';width:16px;height:20px;" name="prevMonth" type="button" id="prevMonth" value="&lt;" /></th>';
  mvAry[mvAry.length]  = '        <th align="center" width="98%" nowrap="nowrap" style="text-align:center;"><select name="calendarYear" id="calendarYear" style="font-size:12px; vertical-align:bottom;"></select>&nbsp;<select name="calendarMonth" id="calendarMonth" style="font-size:12px; vertical-align:bottom;"></select></th>';
...
Calendar.prototype.show = function (dateControl, popControl) {
  ...
  //清空预计到达时间
  document.getElementById("arriveTime").innerHTML = "";
};
...
$("#calendarPanel").mouseover(function () {
                mouseOnDiv = true;
            }).mouseout(function () {
                mouseOnDiv = false;
            }); 
function hideDateDiv(obj){
	if(!mouseOnDiv){//鼠标不在上面
		new Calendar().hide();
	}
}
