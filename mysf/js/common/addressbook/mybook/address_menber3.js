...
//					}
			...
			getCommonImg("1025","N","1");
		},
		error : function(e) {
			$("#waitplease1").hide();
			getCommonImg("1025","N","3");
			console.log("查询失败...");
		}
	});
...
function editAddressInfo(asbkid){
	...
	location.href = "/page/common/addressbook/mybook/address_edit_sent3.html?asbkId="+asbkid;
};
//删除地址簿
...
//						alert("删除成功!");
						if($.trim(data)!=""){
							...
							setTimeout(function() {
								location.href = "/page/common/addressbook/mybook/address_menber3.html";
							},80);
						}else{
...
function checkOne(index){
	...
	setTimeout(function() {
		location.href ="/page/common/addressbook/mybook/addressDetails3.html?sentAsbkId="+index;
