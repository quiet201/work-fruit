...
//			alert("设为默认地址成功");
			if($.trim(data)!="N"){
				...
				getCommonImg("10291","N","2");
			}
		},
		error : function(e) {
			commontipsDialog("选择地址设置失败...");
			console.log("选择地址设置失败...");
			getCommonImg("10291","N","3");
		} 
	});
};
...
function editAddressInfo(asbkid){
	...
	location.href = "/page/common/addressbook/receive/address_edit_sent2.html?asbkId="+asbkid;
};
//删除地址簿
...
//						alert("删除成功!");
						if($.trim(data)!=""){
							...
							setTimeout(function() {
								location.href = "/page/common/addressbook/receive/address_menber2.html";
							},80);
						}else{
