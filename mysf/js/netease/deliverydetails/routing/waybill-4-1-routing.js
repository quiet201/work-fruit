		...
		success : function(data) {
			...
			if (data.state == "Y") {
				...
				$("#evaluateItem").unbind().bind("click",function(){
					...
					location.href="/page/netease/deliverydetails/routing/evaluate.html?type="+tpye+"&json="+json;
				});
			}
		},
		error : function(e) {
...
/*		location.href="/page/netease/deliverydetails/routing/evaluate.html?json="+JSON.stringify(evaluateParams);;*/
	}
};
