...
$(function() {
	...
	$('#btnBack').attr('href','/page/netease/deliverydetails/routing/waybill-2-1-routing.html?bno='+urlParams.bno+'&&hasRoute=true');
});
...
function toWayBill(){
	var url = '/page/netease/deliverydetails/routing/waybill-2-1-routing.html';
