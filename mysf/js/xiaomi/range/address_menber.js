		...
		success : function(data) {
			if (data) {
				...
				for(var i=0;i<data.length;i++){
					...
					str = "<li class='item address-item'><a href='address_minfo.html?asbkId="+data[i].asbkId+"'><div class='ui-flex'><div class='flex-con'><div class='address-top'><span class='name'>"+data[i].userName+"</span>"+
