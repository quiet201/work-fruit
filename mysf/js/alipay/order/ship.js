...
//		cityNames[3] = ['755'];
	...
	function toSelectAddressBook(){
		...
		location.href = "/page/alipay/addressbook/send/address_menber1.html?addressToPage=/page/alipay/order/ship.html&shipAskId="+shipAskId;
	}
			...
			success: function(result){
				if(result){
					if(result.code == "200"){
						...
						clearCookie();
						//跳转成功页面
						window.location = "/page/alipay/order/ship_success.html?resultJson="+JSON.stringify(result);
