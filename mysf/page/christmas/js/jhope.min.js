...
$.fn.alert = function(op) {   
	...
	var temp = [];
	temp.push('<div class="maskbox">');
	temp.push('<div class="prize-note-appear">');
	temp.push('<div class="text-notein">'+op['content']+'</div>');
	temp.push('<a class="know" data-bind="close">我知道了</a>');
	temp.push('</div>');
	temp.push('</div>');
	$(this).append(temp.join(""));
	$(this).find("a[data-bind='close']").tap(function(){
		$(this).parents("div.maskbox").remove();
		op.laterFn && op.laterFn();
	});
};